...
#define CONFIG_EXAMPLE_ETH_PHY_RST_GPIO     33 // This GPIO is actually the LED becasue it seems that ESP32 GATEWAY doesn't have a rst pin connected to the phy
#define	PIN_PHY_POWER	                    5
#define CONFIG_EXAMPLE_ETH_MDC_GPIO         23
#define CONFIG_EXAMPLE_ETH_MDIO_GPIO        18
#define CONFIG_EXAMPLE_USE_INTERNAL_ETHERNET
#define CONFIG_EXAMPLE_ETH_PHY_LAN8720
...
#if defined(CONFIG_EXAMPLE_USE_INTERNAL_ETHERNET)
...
#elif defined(CONFIG_EXAMPLE_ETH_PHY_LAN8720)
    esp_eth_phy_t *phy = esp_eth_phy_new_lan8720(&phy_config);
#elif defined(CONFIG_EXAMPLE_ETH_PHY_DP83848)
    esp_eth_phy_t *phy = esp_eth_phy_new_dp83848(&phy_config);
#endif
#elif defined(CONFIG_EXAMPLE_USE_DM9051)
